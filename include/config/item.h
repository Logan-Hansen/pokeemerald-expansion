...
#define I_EXP_SHARE_FLAG        FLAG_EXPSHAREGEN6  // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not. #was 0
#define I_EXP_SHARE_ITEM        GEN_6       // In Gen6+, the Exp. Share was changed from a held item to a Key item that toggles the effect described above. #was GEN_5
